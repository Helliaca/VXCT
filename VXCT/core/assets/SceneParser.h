...
enum class sp_nodetype { SCENE, MODEL, POSITION, X, Y, Z, NAME, SCALE, ACTIVE, PATH, MATERIAL, SHININESS, SPECULAR_STR, AMBIENT_STR, DIFFUSE_STR, SHADER, COLOR, R, G, B, SCALE_X, SCALE_Y, SCALE_Z, PRIMITIVE, STATIC, LIGHT, ERR };
